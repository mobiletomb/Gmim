...
parser = argparse.ArgumentParser(description="Swin UNETR segmentation pipeline for Amos 2022 Challenge")
...
parser.add_argument("--datasets", default='Amos2022Dataset', type=str)
